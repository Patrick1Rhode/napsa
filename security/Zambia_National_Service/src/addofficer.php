	...
	if(!empty($createpassword) && isset($createpassword) && !empty($confirmpassword) && isset($confirmpassword)){
		if($createpassword == $confirmpassword){
			...
			*/
			...
			//Connect to server
			$connect = mysqli_connect(ZNS_HOSTNAME, ZNS_SERVER_USERNAME, ZNS_SERVER_PASS, ZNS_SERVER_DB) or die("Error connecting to ZNS Server, Please check your connection");
